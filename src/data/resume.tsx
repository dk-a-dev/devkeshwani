...
export const resume: SiteConfig = {
  ...
  contact: {
    socials: [
      ...
      {
        name: "LinkedIn",
        url: "https://linkedin.com/in/dev-keshwani",
        icon: Linkedin,
      },
      {
        name: "Twitter",
  ...
  projects: [
    {
      ...
      images: ["/projects/term-f1.png"],
      description:
        "A Formula 1-themed interactive terminal and web experience. Features a pixel-art loading bar, 3D car animation, and an F1 radio-inspired footer. Built with Go using the Charmbracelet terminal UI framework and a modern React frontend for authentic F1 UI/UX.",
      scope: "Full-Stack Development (Terminal + Web) + Creative UI/UX",
      responsibilities: [
        "Architected a full-featured Formula 1 terminal UI using Go and the Charmbracelet Bubble Tea framework, delivering real-time race data, interactive charts, and a multi-tab navigation experience.",
        "Integrated multiple motorsport data sources (OpenF1, Jolpica/Ergast, Multiviewer, Groq) to provide live standings, session analytics, circuit maps, weather, and AI-powered chat within the terminal.",
        "Engineered a modular UI system with custom Lipgloss styles, supporting dynamic views for race analysis, driver stats, pit stops, and sector breakdowns.",
        "Developed a 3D Formula 1 car animation with approach, center spin, and dynamic exit using Three.js and Framer Motion.",
      ],
      languages: ["Go", "JavaScript", "TypeScript"],
      repoUrl: "https://github.com/dk-a-dev/termf1",
      demoUrl: "https://term-f1.vercel.app/",
    },
    {
      title: "dev.ly",
      client: "Personal Project",
    ...
    },
    {
      ...
      description:
        "A native Swift/SwiftUI Hacker News client inspired by Harmonic for Android. Built with zero third-party dependencies. Features Best/New/Ask/Show/Jobs feeds, time filters, in-app WebView, bookmarks, threaded comments, user profiles, Algolia-powered search, story submission, offline caching, and 7 themes including animated Liquid UI themes.",
    ...
    },
    {
      ...
      description:
        "An art discovery platform leveraging VGG19-based Neural Style Transfer to generate paintings in famous artist styles. Features user authentication, curated galleries, and social sharing.",
    ...
    },
    {
      ...
      description:
        "Production-ready Go REST API with JWT authentication, database migrations, role-based permissions, and Grafana/Graphite monitoring stack achieving 95%+ uptime.",
    ...
    },
    {
      ...
      description:
        "VIT timetable app with 40,000+ total users. Features Circles for connecting with friends, empty classroom finder, iOS widgets, caching & offline-ready timetables, ghost mode, and in-app notifications.",
    ...
    },
    {
      ...
      description:
        "Official VIT Riviera'24 App for international sports and cultural carnival with 30,000+ students from 650+ colleges. Real-time event updates, registration system, and push notifications.",
    ...
    },
    {
      ...
      description:
        "Android library for lock-screen live widgets/notifications with real-time app updates. Includes comprehensive documentation and test suite for seamless integration.",
    ...
    },
    {
      ...
      description:
        "Collaborative playlist app for events, enabling shared Spotify playlist creation and admin moderation. Features event-based state management in SvelteKit.",
    ...
    },
    {
      ...
      description:
        "Stray-dog population heatmap application built during Google SDG Hackathon to assist NGOs. Uses classification models and gRPC-based backend to map stray density.",
      scope: "Mobile App + ML",
      responsibilities: [
    ...
    },
    {
      ...
      description:
        "GitHub Org Data Analyzer providing insights into metrics like active days, longest streaks, month-wise activity, developer activity, and repository activity from GitHub logs.",
    ...
    },
    {
      ...
      description:
        "A typing speed test website inspired by MonkeyType. Users can gauge their typing speed within a 30-second timeframe with customizable themes and a sleek interface.",
    ...
    },
    {
      ...
      description:
        "AI-powered bookkeeping app inspired by Khatabook. Built with a 6-person team using Django, Flutter and Classification Models to record voice-enabled transactions.",
      scope: "Mobile App + AI",
      responsibilities: [
  ...
  sessions: [
    {
      ...
      description:
        "Beginner-friendly sessions on developing Android apps using Kotlin.",
      topics: ["Android Dev", "Kotlin"],
      youtubeEmbedUrl:
        "https://www.youtube.com/embed/NJaEcyOwAu0?si=9gz-fg_LxfxToXHE",
    },
    {
      title: "Android Study Jams: Architecture and Compose",
      description:
        "Deep-dive into app architecture patterns, LiveData, and Jetpack Compose.",
      topics: ["App Architecture", "Kotlin", "Android Dev"],
      youtubeEmbedUrl:
        "https://www.youtube.com/embed/BVpa-QR7GLQ?si=9SJhYkY-N3yXKq09",
    },
    {
      title: "Android Study Jams: Networking and Task Scheduling",
      description:
        "Fetching data from APIs, coroutines, and background task scheduling.",
      topics: ["Android Dev", "Kotlin", "Coroutines"],
      youtubeEmbedUrl:
        "https://www.youtube.com/embed/y9nkT8dHB_0?si=6qKSBn41gC8PhL27",
    },
    {
      title: "PyCamp: Python Libraries",
      description:
        "A series of sessions on Python libraries organised by IEEE-VIT.",
  ...
  blogs: [
    {
      ...
      description:
        'The beautiful game — "Football". With a ball, a field, and unbridled passion, it\'s a sport that speaks a universal language, uniting…',
  ...
  certifications: [
    {
      ...
      description: "CI/CD pipelines, containerization, and monitoring tools.",
    },
    {
      name: "DevOps, Agile & Design Thinking",
      issuer: "IBM Career Education Program",
      description: "Agile frameworks, Scrum practices, and design thinking.",
    },
    {
    ...
    },
    {
      name: "Flutter & Dart",
      issuer: "Udemy",
      description: "Mobile apps with Flutter, Firebase integration, and UI/UX.",
    },
    {
      name: "Postman API Fundamentals Student Expert",
      issuer: "Postman",
      description: "API design, testing, and automation workflows.",
    },
  ],
};
